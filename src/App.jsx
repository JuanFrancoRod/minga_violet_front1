  ...
  return (
    <>
      <div className="min-h-screen">
        <div className="h-[10vh] p-4  bg-white flex justify-between mb-8 mr-44 ml-44">
          <button clas name="bg-slate-800 text-gray-50">
            <svg
          ...
          <div className="h-[25vh] bg-cover bg-gradient-to-b from-[#F9A8D4] to-[#F472B6] w-4/5 flex  items-end justify-around rounded-lg">
            ...
            <div className="flex w-full justify-around">
              <img
                ...
                src="../src/pages/images/8b8e139c764c05a681947b2d6855bd331.png"
              ></img>
              <img
                className="self-center h-60 w-68"
                src="../src/pages/images/image3.png.png"
              ></img>
            </div>
            <div className="flex-column mb-16 w-88">
              <h3 className="text-white text-2xl">Shonen</h3>
        ...
        <div className="flex justify-center flex-column">
          <div className=" h-[53vh] m-8 bg-fondo-main bg-cover w-4/5 flex flex-col justify-center items-center">
            <div className="flex-column justify-center items-center">
              ...
              <h4 className="text-white self Class place-self-auto text-xl m-2">
                {" "}
        ...
        <div className="flex flex-col ">
          <img
            src="../src/pages/images/Rectangle14.png"
            alt=""
